export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-12 space-y-8 bg-gradient-to-br from-purple-100 via-blue-50 to-pink-100">
      ...
      {/* FAQ Section */}
      <section className="w-full max-w-2xl bg-white/80 backdrop-blur-md shadow-lg rounded-2xl p-8 space-y-6 border border-indigo-200">
        ...
        <div className="space-y-4">
          <div className="p-5 rounded-xl bg-gradient-to-r from-pink-200 via-purple-200 to-indigo-200 shadow-md">
            ...
            <p className="text-gray-700">
              FAQ stands for "Frequently Asked Questions" and provides quick answers to common queries.
            </p>
          </div>

          <div className="p-5 rounded-xl bg-gradient-to-r from-green-200 via-teal-200 to-cyan-200 shadow-md">
            <h2 className="font-bold text-lg text-teal-900">Q2: Why do we use FAQs?</h2>
            <p className="text-gray-700">
              FAQs help users save time by finding answers without contacting support.
            </p>
          </div>
          ...
          <div className="p-5 rounded-xl bg-gradient-to-r from-yellow-200 via-orange-200 to-red-200 shadow-md">
            ...
            <p className="text-gray-700">
              Yes, you can add as many FAQs as needed depending on your project.
            </p>
          </div>
        </div>
      </section>
